...
excerpt: 'You’re building the next greatest to-do app and you find yourself wanting to store a function in state…'
date: '2020-08-17'
author:
  name: Austin Blade
...
<img src="https://media.giphy.com/media/457NTDOuMmDfO/giphy.gif" alt="BUT WHY" />
...
export const AddPlumbusContainer = () => {
  const [showAddPlumbusWizard, setShowAddPlumbusWizard] = React.useState<boolean>(false)
...
<h3> Unhandled Rejection (TypeError): onComplete is not a function </h3>
